...
inputData$occupation[is.na(inputData$occupation)] <- "Missing Occupation"
inputData$working_sector[is.na(inputData$working_sector)] <- "Missing working sector"
inputData$country[is.na(inputData$country)] <- "Missing Country"

graderData$occupation[is.na(graderData$occupation)] <- "Missing Occupation"
graderData$working_sector[is.na(graderData$working_sector)] <- "Missing working sector"
graderData$country[is.na(graderData$country)] <- "Missing Country"
